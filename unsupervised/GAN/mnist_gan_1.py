...
def plotLoss(epoch):
    ...
    plt.ylabel('Loss')
    plt.legend()
    plt.savefig('gan_loss_epoch_%d_1000.png' % epoch)
...
def plotGeneratedImages(epoch, examples=100, dim=(10, 10), figsize=(10, 10)):
    ...
    for i in range(generatedImages.shape[0]):
        ...
        plt.axis('off')
    plt.tight_layout()
    plt.savefig('gan_generated_image_epoch_%d_1000.png' % epoch)

# Save the generator and discriminator networks (and weights) for later use
def saveModels(epoch):
    generator.save('gan_generator_epoch_%d_1000.h5' % epoch)
    discriminator.save('gan_discriminator_epoch_%d_1000.h5' % epoch)
