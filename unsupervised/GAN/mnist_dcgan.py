...
def initNormal(shape, name=None, dim_ordering=None):
...
def plotLoss(epoch):
    ...
    plt.ylabel('Loss')
    plt.legend()
    plt.savefig('dcgan_loss_epoch_%d_1000.png' % epoch)
#    print  'dloss: %d' % dloss
#    print  'gloss: %d' % gloss
...
def plotGeneratedImages(epoch, examples=100, dim=(10, 10), figsize=(10, 10)):
    ...
    for i in range(generatedImages.shape[0]):
        ...
        plt.axis('off')
    plt.tight_layout()
    plt.savefig('dcgan_generated_image_epoch_%d_1000.png' % epoch)

# Save the generator and discriminator networks (and weights) for later use
def saveModels(epoch):
    generator.save('dcgan_generator_epoch_%d_1000.h5' % epoch)
    discriminator.save('dcgan_discriminator_epoch_%d_1000.h5' % epoch)
